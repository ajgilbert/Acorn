#ifndef Acorn_Analysis_WGTagAndProbe_h
#define Acorn_Analysis_WGTagAndProbe_h
#include <string>
#include <cstdint>
...
class WGTagAndProbe : public ModuleBase {
 private:
 ...
 public:
  WGTagAndProbe(std::string const& name);
  virtual ~WGTagAndProbe();
