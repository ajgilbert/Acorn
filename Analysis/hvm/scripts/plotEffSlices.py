...
parser.add_argument('--title', default='Electron Trigger Efficiency')
parser.add_argument('--y-range', default='0,1')
parser.add_argument('--ratio-y-range', default='0.85,1.15')
...
for i in xrange(1, hist.GetNbinsY()+1):
    ...
    plot.DrawTitle(pads[0], '35.9 fb^{-1} (13 TeV - 2016)', 3)
    #plot.DrawTitle(pads[0], '41.5 fb^{-1} (13 TeV - 2017)', 3)
    #plot.DrawTitle(pads[0], '59.7 fb^{-1} (13 TeV - 2018)', 3)
