...
for ptcut in range(30, 100, 10):
    for sample in samples:
        hists['m_ll']['pt_%s' % ptcut][sample] = Define('TH1F', (60, 60., 120.), sample, ['m_ll'], sel='pt_1 > %s && trg_1' % ptcut)
        hists['eta_1']['pt_%s' % ptcut][sample] = Define('TH1F', (40, -2.4, 2.4), sample, ['eta_1'], sel='pt_1 > %s && trg_1' % ptcut)
        hists['eta_2']['pt_%s' % ptcut][sample] = Define('TH1F', (40, -2.4, 2.4), sample, ['eta_2'], sel='pt_1 > %s && trg_1' % ptcut)
        hists['pt_1']['pt_%s' % ptcut][sample] = Define('TH1F', (40, 0, 100), sample, ['pt_1'], sel='pt_1 > %s && trg_1' % ptcut)
        hists['pt_2']['pt_%s' % ptcut][sample] = Define('TH1F', (40, 0, 100), sample, ['pt_2'], sel='pt_1 > %s && trg_1' % ptcut)
    for sample in samples:
        hists['m_ll_weighted']['pt_%s' % ptcut][sample] = Define('TH1F', (60, 60., 120.), sample, ['m_ll'], sel='pt_1 > %s && trg_1' % ptcut, wt='wt_pu*wt_1*wt_2*wt_trg1')
        hists['eta_1_weighted']['pt_%s' % ptcut][sample] = Define('TH1F', (40, -2.4, 2.4), sample, ['eta_1'], sel='pt_1 > %s && trg_1' % ptcut, wt='wt_pu*wt_1*wt_2*wt_trg1')
        hists['eta_2_weighted']['pt_%s' % ptcut][sample] = Define('TH1F', (40, -2.4, 2.4), sample, ['eta_2'], sel='pt_1 > %s && trg_1' % ptcut, wt='wt_pu*wt_1*wt_2*wt_trg1')
        hists['pt_1_weighted']['pt_%s' % ptcut][sample] = Define('TH1F', (40, 0, 100), sample, ['pt_1'], sel='pt_1 > %s && trg_1' % ptcut, wt='wt_pu*wt_1*wt_2*wt_trg1')
        hists['pt_2_weighted']['pt_%s' % ptcut][sample] = Define('TH1F', (40, 0, 100), sample, ['pt_2'], sel='pt_1 > %s && trg_1' % ptcut, wt='wt_pu*wt_1*wt_2*wt_trg1')
