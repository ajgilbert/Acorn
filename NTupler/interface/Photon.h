...
class Photon : public Candidate {
 public:
  ...
  inline double worstChargedIsolation() const { return worstChargedIso_; }
  ...
  inline void setWorstChargedIso(double const& worstChargedIso) { worstChargedIso_ = worstChargedIso; }
